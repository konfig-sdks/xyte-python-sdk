...
from xyte_python_sdk.paths.v1_devices_parent_id_children import post
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DevicesParentIdChildren(ApiTestMixin, unittest.TestCase):
    """
    V1DevicesParentIdChildren unit test stubs
