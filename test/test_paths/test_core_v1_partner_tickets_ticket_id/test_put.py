...
from xyte_python_sdk.paths.core_v1_partner_tickets_ticket_id import put
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestCoreV1PartnerTicketsTicketId(ApiTestMixin, unittest.TestCase):
    """
    CoreV1PartnerTicketsTicketId unit test stubs
        Update Ticket
    """
