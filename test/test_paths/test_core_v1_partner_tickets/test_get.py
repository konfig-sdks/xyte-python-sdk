...
from xyte_python_sdk.paths.core_v1_partner_tickets import get
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestCoreV1PartnerTickets(ApiTestMixin, unittest.TestCase):
    """
    CoreV1PartnerTickets unit test stubs
        List Tickets
    """
