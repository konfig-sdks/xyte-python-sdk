...
from xyte_python_sdk.paths.core_v1_partner_devices_device_id import delete
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestCoreV1PartnerDevicesDeviceId(ApiTestMixin, unittest.TestCase):
    """
    CoreV1PartnerDevicesDeviceId unit test stubs
        Delete Device
    """
