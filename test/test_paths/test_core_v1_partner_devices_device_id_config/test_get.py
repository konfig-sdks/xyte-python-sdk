...
from xyte_python_sdk.paths.core_v1_partner_devices_device_id_config import get
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestCoreV1PartnerDevicesDeviceIdConfig(ApiTestMixin, unittest.TestCase):
    """
    CoreV1PartnerDevicesDeviceIdConfig unit test stubs
