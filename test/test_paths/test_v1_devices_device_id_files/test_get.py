...
from xyte_python_sdk.paths.v1_devices_device_id_files import get
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DevicesDeviceIdFiles(ApiTestMixin, unittest.TestCase):
    """
    V1DevicesDeviceIdFiles unit test stubs
        Get Files
    """
