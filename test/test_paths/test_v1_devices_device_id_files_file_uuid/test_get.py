...
from xyte_python_sdk.paths.v1_devices_device_id_files_file_uuid import get
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DevicesDeviceIdFilesFileUuid(ApiTestMixin, unittest.TestCase):
    """
    V1DevicesDeviceIdFilesFileUuid unit test stubs
        Get File
    """
