...
from xyte_python_sdk.paths.core_v1_partner_devices import get
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestCoreV1PartnerDevices(ApiTestMixin, unittest.TestCase):
    """
    CoreV1PartnerDevices unit test stubs
        List Devices
    """
