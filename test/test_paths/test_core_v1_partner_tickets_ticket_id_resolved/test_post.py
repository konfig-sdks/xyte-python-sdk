...
from xyte_python_sdk.paths.core_v1_partner_tickets_ticket_id_resolved import post
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestCoreV1PartnerTicketsTicketIdResolved(ApiTestMixin, unittest.TestCase):
    """
    CoreV1PartnerTicketsTicketIdResolved unit test stubs
        Close Ticket
    """
