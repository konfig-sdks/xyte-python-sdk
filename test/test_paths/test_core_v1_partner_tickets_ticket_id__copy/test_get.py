...
from xyte_python_sdk.paths.core_v1_partner_tickets_ticket_id__copy import get
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestCoreV1PartnerTicketsTicketIdCOPY(ApiTestMixin, unittest.TestCase):
    """
    CoreV1PartnerTicketsTicketIdCOPY unit test stubs
        Get Ticket
    """
