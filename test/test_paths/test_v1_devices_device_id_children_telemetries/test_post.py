...
from xyte_python_sdk.paths.v1_devices_device_id_children_telemetries import post
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DevicesDeviceIdChildrenTelemetries(ApiTestMixin, unittest.TestCase):
    """
    V1DevicesDeviceIdChildrenTelemetries unit test stubs
