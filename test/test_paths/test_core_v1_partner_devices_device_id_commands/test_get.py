...
from xyte_python_sdk.paths.core_v1_partner_devices_device_id_commands import get
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestCoreV1PartnerDevicesDeviceIdCommands(ApiTestMixin, unittest.TestCase):
    """
    CoreV1PartnerDevicesDeviceIdCommands unit test stubs
        Get Device Commands
    """
