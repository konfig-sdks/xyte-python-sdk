...
from xyte_python_sdk.paths.v1_devices_device_id_telemetry import post
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DevicesDeviceIdTelemetry(ApiTestMixin, unittest.TestCase):
    """
    V1DevicesDeviceIdTelemetry unit test stubs
        Send Telemetry
    """
