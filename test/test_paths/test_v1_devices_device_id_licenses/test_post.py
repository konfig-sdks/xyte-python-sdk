...
from xyte_python_sdk.paths.v1_devices_device_id_licenses import post
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DevicesDeviceIdLicenses(ApiTestMixin, unittest.TestCase):
    """
    V1DevicesDeviceIdLicenses unit test stubs
        Update License
    """
