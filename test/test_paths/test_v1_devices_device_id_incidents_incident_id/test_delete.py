...
from xyte_python_sdk.paths.v1_devices_device_id_incidents_incident_id import delete
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DevicesDeviceIdIncidentsIncidentId(ApiTestMixin, unittest.TestCase):
    """
    V1DevicesDeviceIdIncidentsIncidentId unit test stubs
        Close Incident
    """
