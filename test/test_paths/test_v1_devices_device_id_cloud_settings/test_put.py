...
from xyte_python_sdk.paths.v1_devices_device_id_cloud_settings import put
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DevicesDeviceIdCloudSettings(ApiTestMixin, unittest.TestCase):
    """
    V1DevicesDeviceIdCloudSettings unit test stubs
        Set Cloud Settings
    """
