...
from xyte_python_sdk.paths.v1_devices_device_id_dumps_mime_type_filename import post
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DevicesDeviceIdDumpsMimeTypeFilename(ApiTestMixin, unittest.TestCase):
    """
    V1DevicesDeviceIdDumpsMimeTypeFilename unit test stubs
        Send Dump
    """
