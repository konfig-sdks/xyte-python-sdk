...
from xyte_python_sdk.paths.core_v1_partner_tickets_ticket_id_message import post
from xyte_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestCoreV1PartnerTicketsTicketIdMessage(ApiTestMixin, unittest.TestCase):
    """
    CoreV1PartnerTicketsTicketIdMessage unit test stubs
        Add Comment
    """
