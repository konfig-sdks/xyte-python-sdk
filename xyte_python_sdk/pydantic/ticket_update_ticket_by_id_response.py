...
from xyte_python_sdk.pydantic.ticket_update_ticket_by_id_response_comments import TicketUpdateTicketByIdResponseComments

class TicketUpdateTicketByIdResponse(BaseModel):
    ...
    comments: typing.Optional[TicketUpdateTicketByIdResponseComments] = Field(None, alias='comments')
