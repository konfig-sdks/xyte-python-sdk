...
from xyte_python_sdk.pydantic.device_get_info200_response_data import DeviceGetInfo200ResponseData
from xyte_python_sdk.pydantic.device_get_info200_response_page_info import DeviceGetInfo200ResponsePageInfo

class DeviceGetInfo200Response(BaseModel):
    data: typing.Optional[DeviceGetInfo200ResponseData] = Field(None, alias='data')

    page_info: typing.Optional[DeviceGetInfo200ResponsePageInfo] = Field(None, alias='page_info')
