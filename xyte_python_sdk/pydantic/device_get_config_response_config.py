...
from xyte_python_sdk.pydantic.device_get_config_response_config_network import DeviceGetConfigResponseConfigNetwork
from xyte_python_sdk.pydantic.device_get_config_response_config_other import DeviceGetConfigResponseConfigOther

class DeviceGetConfigResponseConfig(BaseModel):
    network: typing.Optional[DeviceGetConfigResponseConfigNetwork] = Field(None, alias='network')

    other: typing.Optional[DeviceGetConfigResponseConfigOther] = Field(None, alias='other')
