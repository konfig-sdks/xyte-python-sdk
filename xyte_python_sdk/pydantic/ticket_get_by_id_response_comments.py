...
from xyte_python_sdk.pydantic.ticket_get_by_id_response_comments_item import TicketGetByIdResponseCommentsItem

TicketGetByIdResponseComments = typing.List[TicketGetByIdResponseCommentsItem]
