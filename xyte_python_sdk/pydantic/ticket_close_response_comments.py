...
from xyte_python_sdk.pydantic.ticket_close_response_comments_item import TicketCloseResponseCommentsItem

TicketCloseResponseComments = typing.List[TicketCloseResponseCommentsItem]
