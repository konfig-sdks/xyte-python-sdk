...
from xyte_python_sdk.pydantic.device_get_telemetries_response_item_telemetries import DeviceGetTelemetriesResponseItemTelemetries

class DeviceGetTelemetriesResponseItem(BaseModel):
    created_at: typing.Optional[str] = Field(None, alias='created_at')

    device_timestamp: typing.Optional[str] = Field(None, alias='device_timestamp')

    telemetries: typing.Optional[DeviceGetTelemetriesResponseItemTelemetries] = Field(None, alias='telemetries')
