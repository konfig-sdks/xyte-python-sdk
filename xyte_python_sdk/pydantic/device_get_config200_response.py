...
class DeviceGetConfig200Response(BaseModel):
    version: typing.Optional[int] = Field(None, alias='version')

    last_updated: typing.Optional[str] = Field(None, alias='last_updated')

    config: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = Field(None, alias='config')
