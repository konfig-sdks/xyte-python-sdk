...
class DeviceSendTelemetryResponse(BaseModel):
    ...
    latest_fw_version: typing.Optional[str] = Field(None, alias='latest_fw_version')

    latest_fw_file_id: typing.Optional[str] = Field(None, alias='latest_fw_file_id')
