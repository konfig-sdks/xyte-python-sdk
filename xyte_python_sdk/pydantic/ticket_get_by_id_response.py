...
from xyte_python_sdk.pydantic.ticket_get_by_id_response_comments import TicketGetByIdResponseComments

class TicketGetByIdResponse(BaseModel):
    ...
    comments: typing.Optional[TicketGetByIdResponseComments] = Field(None, alias='comments')
