...
class DeviceCreateRegistrationResponse(BaseModel):
    id: typing.Optional[str] = Field(None, alias='id')

    access_key: typing.Optional[str] = Field(None, alias='access_key')

    hub_url: typing.Optional[str] = Field(None, alias='hub_url')

    hub_url_static_cert: typing.Optional[str] = Field(None, alias='hub_url_static_cert')

    mqtt_hub_url: typing.Optional[str] = Field(None, alias='mqtt_hub_url')
