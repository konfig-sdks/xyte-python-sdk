...
class DeviceUpdateDeviceResponseCustom(BaseModel):
    prompt: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='prompt')
