...
from xyte_python_sdk.pydantic.ticket_add_comment_response_comments import TicketAddCommentResponseComments

class TicketAddCommentResponse(BaseModel):
    ...
    comments: typing.Optional[TicketAddCommentResponseComments] = Field(None, alias='comments')
