...
from xyte_python_sdk.pydantic.ticket_add_comment_response_comments_item import TicketAddCommentResponseCommentsItem

TicketAddCommentResponseComments = typing.List[TicketAddCommentResponseCommentsItem]
