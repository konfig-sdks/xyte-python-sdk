...
from xyte_python_sdk.pydantic.device_list_commands_response_data import DeviceListCommandsResponseData
from xyte_python_sdk.pydantic.device_list_commands_response_page_info import DeviceListCommandsResponsePageInfo

class DeviceListCommandsResponse(BaseModel):
    data: typing.Optional[DeviceListCommandsResponseData] = Field(None, alias='data')

    page_info: typing.Optional[DeviceListCommandsResponsePageInfo] = Field(None, alias='page_info')
