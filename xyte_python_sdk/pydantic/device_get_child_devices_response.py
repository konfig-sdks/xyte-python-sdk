...
from xyte_python_sdk.pydantic.device_get_child_devices_response_item import DeviceGetChildDevicesResponseItem

DeviceGetChildDevicesResponse = typing.List[DeviceGetChildDevicesResponseItem]
