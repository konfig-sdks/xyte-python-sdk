...
from xyte_python_sdk.pydantic.ticket_update_ticket_by_id_response_comments_item import TicketUpdateTicketByIdResponseCommentsItem

TicketUpdateTicketByIdResponseComments = typing.List[TicketUpdateTicketByIdResponseCommentsItem]
