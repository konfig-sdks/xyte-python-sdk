...
class DeviceGetChildDevicesResponseItem(BaseModel):
    id: typing.Optional[str] = Field(None, alias='id')

    sn: typing.Optional[str] = Field(None, alias='sn')

    mac: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='mac')
