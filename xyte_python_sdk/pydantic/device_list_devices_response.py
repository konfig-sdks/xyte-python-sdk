...
from xyte_python_sdk.pydantic.device_list_devices_response_data import DeviceListDevicesResponseData
from xyte_python_sdk.pydantic.device_list_devices_response_page_info import DeviceListDevicesResponsePageInfo

class DeviceListDevicesResponse(BaseModel):
    data: typing.Optional[DeviceListDevicesResponseData] = Field(None, alias='data')

    page_info: typing.Optional[DeviceListDevicesResponsePageInfo] = Field(None, alias='page_info')
