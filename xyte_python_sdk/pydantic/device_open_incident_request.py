...
class DeviceOpenIncidentRequest(BaseModel):
    # Short title
    ...
    priority: typing.Optional[Literal["1", "2", "3", "4", "5"]] = Field(None, alias='priority')

    # Short text to uniquely identify the issue (only one incident of each issue type can be open at a time)
    issue: typing.Optional[str] = Field(None, alias='issue')
