...
class DeviceSendTelemetryRequest(BaseModel):
    status: str = Field(alias='status')

    timestamp: typing.Optional[date] = Field(None, alias='timestamp')

    telemetries: typing.Optional[str] = Field(None, alias='telemetries')

    override: typing.Optional[bool] = Field(None, alias='override')
