...
from xyte_python_sdk.pydantic.device_get_telemetries_response_item import DeviceGetTelemetriesResponseItem

DeviceGetTelemetriesResponse = typing.List[DeviceGetTelemetriesResponseItem]
