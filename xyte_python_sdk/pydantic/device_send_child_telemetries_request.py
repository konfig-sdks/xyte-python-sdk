...
class DeviceSendChildTelemetriesRequest(BaseModel):
    # Mapping of child device UUIDs to telemetry data for each device
    r_a_w__b_o_d_y: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(alias='RAW_BODY')
