...
from xyte_python_sdk.pydantic.device_get_config_response_config import DeviceGetConfigResponseConfig

class DeviceGetConfigResponse(BaseModel):
    version: typing.Optional[int] = Field(None, alias='version')

    name: typing.Optional[str] = Field(None, alias='name')

    last_updated: typing.Optional[str] = Field(None, alias='last_updated')

    config: typing.Optional[DeviceGetConfigResponseConfig] = Field(None, alias='config')
