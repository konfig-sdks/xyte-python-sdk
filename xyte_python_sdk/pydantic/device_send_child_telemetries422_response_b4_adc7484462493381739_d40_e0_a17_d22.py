...
class DeviceSendChildTelemetries422ResponseB4Adc7484462493381739D40E0A17D22(BaseModel):
    config_version: typing.Optional[int] = Field(None, alias='config_version')

    command: typing.Optional[bool] = Field(None, alias='command')

    info_version: typing.Optional[int] = Field(None, alias='info_version')

    new_licenses: typing.Optional[bool] = Field(None, alias='new_licenses')

    latest_fw_version: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='latest_fw_version')

    latest_fw_file_id: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='latest_fw_file_id')

    space_data_version: typing.Optional[int] = Field(None, alias='space_data_version')
