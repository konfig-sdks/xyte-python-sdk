...
from xyte_python_sdk.pydantic.device_get_space_info_response_location_coordinates import DeviceGetSpaceInfoResponseLocationCoordinates

class DeviceGetSpaceInfoResponseLocation(BaseModel):
    coordinates: typing.Optional[DeviceGetSpaceInfoResponseLocationCoordinates] = Field(None, alias='coordinates')
