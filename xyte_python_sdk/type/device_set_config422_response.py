...
class RequiredDeviceSetConfig422Response(TypedDict):
    pass

class OptionalDeviceSetConfig422Response(TypedDict, total=False):
    error: str

class DeviceSetConfig422Response(RequiredDeviceSetConfig422Response, OptionalDeviceSetConfig422Response):
    pass
