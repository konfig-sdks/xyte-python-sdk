...
class RequiredDeviceGetConfig200Response(TypedDict):
    pass

class OptionalDeviceGetConfig200Response(TypedDict, total=False):
    version: int

    last_updated: str

    config: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class DeviceGetConfig200Response(RequiredDeviceGetConfig200Response, OptionalDeviceGetConfig200Response):
    pass
