...
class RequiredDeviceCreateRegistration400Response(TypedDict):
    pass

class OptionalDeviceCreateRegistration400Response(TypedDict, total=False):
    error: str

class DeviceCreateRegistration400Response(RequiredDeviceCreateRegistration400Response, OptionalDeviceCreateRegistration400Response):
    pass
