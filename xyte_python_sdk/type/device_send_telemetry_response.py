...
class RequiredDeviceSendTelemetryResponse(TypedDict):
    pass

class OptionalDeviceSendTelemetryResponse(TypedDict, total=False):
    config_version: int
    ...
    latest_fw_file_id: str

    space_data_version: int

    success: bool

class DeviceSendTelemetryResponse(RequiredDeviceSendTelemetryResponse, OptionalDeviceSendTelemetryResponse):
    pass
