...
class RequiredTicketCloseResponseCommentsItem(TypedDict):
    pass

class OptionalTicketCloseResponseCommentsItem(TypedDict, total=False):
    id: int
...
class TicketCloseResponseCommentsItem(RequiredTicketCloseResponseCommentsItem, OptionalTicketCloseResponseCommentsItem):
    pass
