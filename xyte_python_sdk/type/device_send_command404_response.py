...
class RequiredDeviceSendCommand404Response(TypedDict):
    pass

class OptionalDeviceSendCommand404Response(TypedDict, total=False):
    error: str

class DeviceSendCommand404Response(RequiredDeviceSendCommand404Response, OptionalDeviceSendCommand404Response):
    pass
