...
class RequiredDeviceUpdateLicense422Response(TypedDict):
    pass

class OptionalDeviceUpdateLicense422Response(TypedDict, total=False):
    error: str

class DeviceUpdateLicense422Response(RequiredDeviceUpdateLicense422Response, OptionalDeviceUpdateLicense422Response):
    pass
