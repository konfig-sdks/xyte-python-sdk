...
class RequiredDeviceGetTelemetriesResponseItemTelemetries(TypedDict):
    pass

class OptionalDeviceGetTelemetriesResponseItemTelemetries(TypedDict, total=False):
    temp: int
    ...
    fan_speed: typing.Union[int, float]

class DeviceGetTelemetriesResponseItemTelemetries(RequiredDeviceGetTelemetriesResponseItemTelemetries, OptionalDeviceGetTelemetriesResponseItemTelemetries):
    pass
