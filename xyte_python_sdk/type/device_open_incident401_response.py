...
class RequiredDeviceOpenIncident401Response(TypedDict):
    pass

class OptionalDeviceOpenIncident401Response(TypedDict, total=False):
    error: str

class DeviceOpenIncident401Response(RequiredDeviceOpenIncident401Response, OptionalDeviceOpenIncident401Response):
    pass
