...
class RequiredDeviceCloseIncident404Response(TypedDict):
    pass

class OptionalDeviceCloseIncident404Response(TypedDict, total=False):
    error: str

class DeviceCloseIncident404Response(RequiredDeviceCloseIncident404Response, OptionalDeviceCloseIncident404Response):
    pass
