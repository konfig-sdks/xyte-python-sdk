...
class RequiredTicketListResponseItem(TypedDict):
    pass

class OptionalTicketListResponseItem(TypedDict, total=False):
    title: str
...
class TicketListResponseItem(RequiredTicketListResponseItem, OptionalTicketListResponseItem):
    pass
