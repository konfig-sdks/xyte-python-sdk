...
class RequiredDeviceOpenIncident422Response(TypedDict):
    pass

class OptionalDeviceOpenIncident422Response(TypedDict, total=False):
    error: str

class DeviceOpenIncident422Response(RequiredDeviceOpenIncident422Response, OptionalDeviceOpenIncident422Response):
    pass
