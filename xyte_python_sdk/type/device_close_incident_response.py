...
class RequiredDeviceCloseIncidentResponse(TypedDict):
    pass

class OptionalDeviceCloseIncidentResponse(TypedDict, total=False):
    success: bool

class DeviceCloseIncidentResponse(RequiredDeviceCloseIncidentResponse, OptionalDeviceCloseIncidentResponse):
    pass
