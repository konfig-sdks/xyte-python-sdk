...
class RequiredDeviceGetSpaceInfoResponseLocationCoordinates(TypedDict):
    pass

class OptionalDeviceGetSpaceInfoResponseLocationCoordinates(TypedDict, total=False):
    lat: typing.Union[int, float]

    lng: typing.Union[int, float]

class DeviceGetSpaceInfoResponseLocationCoordinates(RequiredDeviceGetSpaceInfoResponseLocationCoordinates, OptionalDeviceGetSpaceInfoResponseLocationCoordinates):
    pass
