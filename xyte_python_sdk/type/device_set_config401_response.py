...
class RequiredDeviceSetConfig401Response(TypedDict):
    pass

class OptionalDeviceSetConfig401Response(TypedDict, total=False):
    error: str

class DeviceSetConfig401Response(RequiredDeviceSetConfig401Response, OptionalDeviceSetConfig401Response):
    pass
