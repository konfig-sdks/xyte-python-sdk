...
class RequiredDeviceListDevices401Response(TypedDict):
    pass

class OptionalDeviceListDevices401Response(TypedDict, total=False):
    error: str

class DeviceListDevices401Response(RequiredDeviceListDevices401Response, OptionalDeviceListDevices401Response):
    pass
