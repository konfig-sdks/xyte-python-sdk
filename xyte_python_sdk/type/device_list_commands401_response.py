...
class RequiredDeviceListCommands401Response(TypedDict):
    pass

class OptionalDeviceListCommands401Response(TypedDict, total=False):
    error: str

class DeviceListCommands401Response(RequiredDeviceListCommands401Response, OptionalDeviceListCommands401Response):
    pass
