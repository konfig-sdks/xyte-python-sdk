...
class RequiredTicketGetByIdResponseCommentsItem(TypedDict):
    pass

class OptionalTicketGetByIdResponseCommentsItem(TypedDict, total=False):
    id: int
...
class TicketGetByIdResponseCommentsItem(RequiredTicketGetByIdResponseCommentsItem, OptionalTicketGetByIdResponseCommentsItem):
    pass
