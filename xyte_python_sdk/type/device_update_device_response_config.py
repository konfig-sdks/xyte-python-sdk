...
class RequiredDeviceUpdateDeviceResponseConfig(TypedDict):
    pass

class OptionalDeviceUpdateDeviceResponseConfig(TypedDict, total=False):
    version: int

    last_updated: str

class DeviceUpdateDeviceResponseConfig(RequiredDeviceUpdateDeviceResponseConfig, OptionalDeviceUpdateDeviceResponseConfig):
    pass
