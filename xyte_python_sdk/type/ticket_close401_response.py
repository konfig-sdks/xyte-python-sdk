...
class RequiredTicketClose401Response(TypedDict):
    pass

class OptionalTicketClose401Response(TypedDict, total=False):
    error: str

class TicketClose401Response(RequiredTicketClose401Response, OptionalTicketClose401Response):
    pass
