...
class RequiredDeviceSetConfigRequest(TypedDict):
    pass

class OptionalDeviceSetConfigRequest(TypedDict, total=False):
    # Put your raw JSON config here
    RAW_BODY: str

class DeviceSetConfigRequest(RequiredDeviceSetConfigRequest, OptionalDeviceSetConfigRequest):
    pass
