...
class RequiredDeviceAppendDumpFile401Response(TypedDict):
    pass

class OptionalDeviceAppendDumpFile401Response(TypedDict, total=False):
    error: str

class DeviceAppendDumpFile401Response(RequiredDeviceAppendDumpFile401Response, OptionalDeviceAppendDumpFile401Response):
    pass
