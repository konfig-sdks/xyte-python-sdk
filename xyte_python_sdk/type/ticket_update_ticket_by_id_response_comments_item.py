...
class RequiredTicketUpdateTicketByIdResponseCommentsItem(TypedDict):
    pass

class OptionalTicketUpdateTicketByIdResponseCommentsItem(TypedDict, total=False):
    id: int
...
class TicketUpdateTicketByIdResponseCommentsItem(RequiredTicketUpdateTicketByIdResponseCommentsItem, OptionalTicketUpdateTicketByIdResponseCommentsItem):
    pass
