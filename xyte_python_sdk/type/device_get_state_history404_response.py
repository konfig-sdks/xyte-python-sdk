...
class RequiredDeviceGetStateHistory404Response(TypedDict):
    pass

class OptionalDeviceGetStateHistory404Response(TypedDict, total=False):
    error: str

class DeviceGetStateHistory404Response(RequiredDeviceGetStateHistory404Response, OptionalDeviceGetStateHistory404Response):
    pass
