...
class RequiredDeviceRegisterChildDeviceRequest(TypedDict):
    firmware_version: str

    model_id: str

class OptionalDeviceRegisterChildDeviceRequest(TypedDict, total=False):
    sub_model: str
...
class DeviceRegisterChildDeviceRequest(RequiredDeviceRegisterChildDeviceRequest, OptionalDeviceRegisterChildDeviceRequest):
    pass
