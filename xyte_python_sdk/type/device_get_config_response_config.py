...
from xyte_python_sdk.type.device_get_config_response_config_network import DeviceGetConfigResponseConfigNetwork
from xyte_python_sdk.type.device_get_config_response_config_other import DeviceGetConfigResponseConfigOther

class RequiredDeviceGetConfigResponseConfig(TypedDict):
    pass

class OptionalDeviceGetConfigResponseConfig(TypedDict, total=False):
    network: DeviceGetConfigResponseConfigNetwork

    other: DeviceGetConfigResponseConfigOther

class DeviceGetConfigResponseConfig(RequiredDeviceGetConfigResponseConfig, OptionalDeviceGetConfigResponseConfig):
    pass
