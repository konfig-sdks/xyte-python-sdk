...
class RequiredDeviceGetAllDeviceStateHistories401Response(TypedDict):
    pass

class OptionalDeviceGetAllDeviceStateHistories401Response(TypedDict, total=False):
    error: str

class DeviceGetAllDeviceStateHistories401Response(RequiredDeviceGetAllDeviceStateHistories401Response, OptionalDeviceGetAllDeviceStateHistories401Response):
    pass
