...
class RequiredDeviceCloseIncident401Response(TypedDict):
    pass

class OptionalDeviceCloseIncident401Response(TypedDict, total=False):
    error: str

class DeviceCloseIncident401Response(RequiredDeviceCloseIncident401Response, OptionalDeviceCloseIncident401Response):
    pass
