...
class RequiredDeviceGetConfigResponseConfigOther(TypedDict):
    pass

class OptionalDeviceGetConfigResponseConfigOther(TypedDict, total=False):
    data: str

class DeviceGetConfigResponseConfigOther(RequiredDeviceGetConfigResponseConfigOther, OptionalDeviceGetConfigResponseConfigOther):
    pass
