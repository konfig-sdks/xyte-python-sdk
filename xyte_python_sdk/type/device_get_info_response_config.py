...
class RequiredDeviceGetInfoResponseConfig(TypedDict):
    pass

class OptionalDeviceGetInfoResponseConfig(TypedDict, total=False):
    version: int
...
class DeviceGetInfoResponseConfig(RequiredDeviceGetInfoResponseConfig, OptionalDeviceGetInfoResponseConfig):
    pass
