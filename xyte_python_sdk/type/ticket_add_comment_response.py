...
from xyte_python_sdk.type.ticket_add_comment_response_comments import TicketAddCommentResponseComments

class RequiredTicketAddCommentResponse(TypedDict):
    pass

class OptionalTicketAddCommentResponse(TypedDict, total=False):
    title: str
    ...
    comments: TicketAddCommentResponseComments

class TicketAddCommentResponse(RequiredTicketAddCommentResponse, OptionalTicketAddCommentResponse):
    pass
