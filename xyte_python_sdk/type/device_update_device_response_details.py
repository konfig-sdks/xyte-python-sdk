...
class RequiredDeviceUpdateDeviceResponseDetails(TypedDict):
    pass

class OptionalDeviceUpdateDeviceResponseDetails(TypedDict, total=False):
    checking: str

class DeviceUpdateDeviceResponseDetails(RequiredDeviceUpdateDeviceResponseDetails, OptionalDeviceUpdateDeviceResponseDetails):
    pass
