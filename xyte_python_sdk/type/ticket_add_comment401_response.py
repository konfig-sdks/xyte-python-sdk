...
class RequiredTicketAddComment401Response(TypedDict):
    pass

class OptionalTicketAddComment401Response(TypedDict, total=False):
    error: str

class TicketAddComment401Response(RequiredTicketAddComment401Response, OptionalTicketAddComment401Response):
    pass
