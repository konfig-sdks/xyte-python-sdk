...
class RequiredDeviceGetFile400Response(TypedDict):
    pass

class OptionalDeviceGetFile400Response(TypedDict, total=False):
    error: str

class DeviceGetFile400Response(RequiredDeviceGetFile400Response, OptionalDeviceGetFile400Response):
    pass
