...
class RequiredDeviceRegisterChildDevice401Response(TypedDict):
    pass

class OptionalDeviceRegisterChildDevice401Response(TypedDict, total=False):
    error: str

class DeviceRegisterChildDevice401Response(RequiredDeviceRegisterChildDevice401Response, OptionalDeviceRegisterChildDevice401Response):
    pass
