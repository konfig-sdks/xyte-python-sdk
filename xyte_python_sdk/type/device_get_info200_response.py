...
from xyte_python_sdk.type.device_get_info200_response_data import DeviceGetInfo200ResponseData
from xyte_python_sdk.type.device_get_info200_response_page_info import DeviceGetInfo200ResponsePageInfo

class RequiredDeviceGetInfo200Response(TypedDict):
    pass

class OptionalDeviceGetInfo200Response(TypedDict, total=False):
    data: DeviceGetInfo200ResponseData

    page_info: DeviceGetInfo200ResponsePageInfo

class DeviceGetInfo200Response(RequiredDeviceGetInfo200Response, OptionalDeviceGetInfo200Response):
    pass
