...
class RequiredDeviceUpdateDeviceRequest(TypedDict):
    pass

class OptionalDeviceUpdateDeviceRequest(TypedDict, total=False):
...
class DeviceUpdateDeviceRequest(RequiredDeviceUpdateDeviceRequest, OptionalDeviceUpdateDeviceRequest):
    pass
