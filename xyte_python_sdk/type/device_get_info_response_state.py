...
class RequiredDeviceGetInfoResponseState(TypedDict):
    pass

class OptionalDeviceGetInfoResponseState(TypedDict, total=False):
    status: str

class DeviceGetInfoResponseState(RequiredDeviceGetInfoResponseState, OptionalDeviceGetInfoResponseState):
    pass
