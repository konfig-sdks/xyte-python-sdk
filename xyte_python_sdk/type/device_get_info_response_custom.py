...
class RequiredDeviceGetInfoResponseCustom(TypedDict):
    pass

class OptionalDeviceGetInfoResponseCustom(TypedDict, total=False):
    prompt: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

class DeviceGetInfoResponseCustom(RequiredDeviceGetInfoResponseCustom, OptionalDeviceGetInfoResponseCustom):
    pass
