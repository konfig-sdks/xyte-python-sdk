...
class RequiredDeviceGetInfoResponsePartner(TypedDict):
    pass

class OptionalDeviceGetInfoResponsePartner(TypedDict, total=False):
    sn: str
...
class DeviceGetInfoResponsePartner(RequiredDeviceGetInfoResponsePartner, OptionalDeviceGetInfoResponsePartner):
    pass
