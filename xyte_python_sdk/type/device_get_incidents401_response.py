...
class RequiredDeviceGetIncidents401Response(TypedDict):
    pass

class OptionalDeviceGetIncidents401Response(TypedDict, total=False):
    error: str

class DeviceGetIncidents401Response(RequiredDeviceGetIncidents401Response, OptionalDeviceGetIncidents401Response):
    pass
