...
class RequiredDeviceUpdateLicenseResponse(TypedDict):
    pass

class OptionalDeviceUpdateLicenseResponse(TypedDict, total=False):
    data: str
...
class DeviceUpdateLicenseResponse(RequiredDeviceUpdateLicenseResponse, OptionalDeviceUpdateLicenseResponse):
    pass
