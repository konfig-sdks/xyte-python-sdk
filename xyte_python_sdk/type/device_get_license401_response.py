...
class RequiredDeviceGetLicense401Response(TypedDict):
    pass

class OptionalDeviceGetLicense401Response(TypedDict, total=False):
    error: str

class DeviceGetLicense401Response(RequiredDeviceGetLicense401Response, OptionalDeviceGetLicense401Response):
    pass
