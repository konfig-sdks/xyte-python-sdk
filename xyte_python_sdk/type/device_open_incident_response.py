...
class RequiredDeviceOpenIncidentResponse(TypedDict):
    pass

class OptionalDeviceOpenIncidentResponse(TypedDict, total=False):
    incident_id: str

class DeviceOpenIncidentResponse(RequiredDeviceOpenIncidentResponse, OptionalDeviceOpenIncidentResponse):
    pass
