...
class RequiredDeviceDeleteDevice404Response(TypedDict):
    pass

class OptionalDeviceDeleteDevice404Response(TypedDict, total=False):
    error: str

class DeviceDeleteDevice404Response(RequiredDeviceDeleteDevice404Response, OptionalDeviceDeleteDevice404Response):
    pass
