...
class RequiredDeviceSendDumpFile422Response(TypedDict):
    pass

class OptionalDeviceSendDumpFile422Response(TypedDict, total=False):
    error: str

class DeviceSendDumpFile422Response(RequiredDeviceSendDumpFile422Response, OptionalDeviceSendDumpFile422Response):
    pass
