...
class RequiredDeviceSendCommand422Response(TypedDict):
    pass

class OptionalDeviceSendCommand422Response(TypedDict, total=False):
    error: str

class DeviceSendCommand422Response(RequiredDeviceSendCommand422Response, OptionalDeviceSendCommand422Response):
    pass
