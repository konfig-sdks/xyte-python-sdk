...
class RequiredDeviceUpdateDeviceResponseCustom(TypedDict):
    pass

class OptionalDeviceUpdateDeviceResponseCustom(TypedDict, total=False):
    prompt: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

class DeviceUpdateDeviceResponseCustom(RequiredDeviceUpdateDeviceResponseCustom, OptionalDeviceUpdateDeviceResponseCustom):
    pass
