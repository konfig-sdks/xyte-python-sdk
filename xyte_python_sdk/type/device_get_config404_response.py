...
class RequiredDeviceGetConfig404Response(TypedDict):
    pass

class OptionalDeviceGetConfig404Response(TypedDict, total=False):
    error: str

class DeviceGetConfig404Response(RequiredDeviceGetConfig404Response, OptionalDeviceGetConfig404Response):
    pass
