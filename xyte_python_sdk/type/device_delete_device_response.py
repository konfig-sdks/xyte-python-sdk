...
class RequiredDeviceDeleteDeviceResponse(TypedDict):
    pass

class OptionalDeviceDeleteDeviceResponse(TypedDict, total=False):
    success: bool

class DeviceDeleteDeviceResponse(RequiredDeviceDeleteDeviceResponse, OptionalDeviceDeleteDeviceResponse):
    pass
