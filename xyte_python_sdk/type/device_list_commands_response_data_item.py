...
class RequiredDeviceListCommandsResponseDataItem(TypedDict):
    pass

class OptionalDeviceListCommandsResponseDataItem(TypedDict, total=False):
    parameters: typing.Union[bool, date, datetime, dict, float, int, list, str, None]
...
class DeviceListCommandsResponseDataItem(RequiredDeviceListCommandsResponseDataItem, OptionalDeviceListCommandsResponseDataItem):
    pass
