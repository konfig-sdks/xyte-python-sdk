...
class RequiredDeviceCreateRegistrationResponse(TypedDict):
    pass

class OptionalDeviceCreateRegistrationResponse(TypedDict, total=False):
    id: str
    ...
    hub_url_static_cert: str

    mqtt_hub_url: str

class DeviceCreateRegistrationResponse(RequiredDeviceCreateRegistrationResponse, OptionalDeviceCreateRegistrationResponse):
    pass
