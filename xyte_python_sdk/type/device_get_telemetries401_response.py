...
class RequiredDeviceGetTelemetries401Response(TypedDict):
    pass

class OptionalDeviceGetTelemetries401Response(TypedDict, total=False):
    error: str

class DeviceGetTelemetries401Response(RequiredDeviceGetTelemetries401Response, OptionalDeviceGetTelemetries401Response):
    pass
