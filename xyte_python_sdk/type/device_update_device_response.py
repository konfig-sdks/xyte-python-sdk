...
from xyte_python_sdk.type.device_update_device_response_config import DeviceUpdateDeviceResponseConfig
from xyte_python_sdk.type.device_update_device_response_custom import DeviceUpdateDeviceResponseCustom
from xyte_python_sdk.type.device_update_device_response_details import DeviceUpdateDeviceResponseDetails
from xyte_python_sdk.type.device_update_device_response_partner import DeviceUpdateDeviceResponsePartner
from xyte_python_sdk.type.device_update_device_response_state import DeviceUpdateDeviceResponseState

class RequiredDeviceUpdateDeviceResponse(TypedDict):
    pass

class OptionalDeviceUpdateDeviceResponse(TypedDict, total=False):
    id: str
    ...
    custom: DeviceUpdateDeviceResponseCustom
...
class DeviceUpdateDeviceResponse(RequiredDeviceUpdateDeviceResponse, OptionalDeviceUpdateDeviceResponse):
    pass
