...
from xyte_python_sdk.type.ticket_update_ticket_by_id_response_comments import TicketUpdateTicketByIdResponseComments

class RequiredTicketUpdateTicketByIdResponse(TypedDict):
    pass

class OptionalTicketUpdateTicketByIdResponse(TypedDict, total=False):
    title: str
    ...
    comments: TicketUpdateTicketByIdResponseComments

class TicketUpdateTicketByIdResponse(RequiredTicketUpdateTicketByIdResponse, OptionalTicketUpdateTicketByIdResponse):
    pass
