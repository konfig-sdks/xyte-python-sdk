...
class RequiredDeviceGetFiles400Response(TypedDict):
    pass

class OptionalDeviceGetFiles400Response(TypedDict, total=False):
    error: str

class DeviceGetFiles400Response(RequiredDeviceGetFiles400Response, OptionalDeviceGetFiles400Response):
    pass
