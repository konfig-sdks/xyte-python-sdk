...
from xyte_python_sdk.type.device_get_config_response_config import DeviceGetConfigResponseConfig

class RequiredDeviceGetConfigResponse(TypedDict):
    pass

class OptionalDeviceGetConfigResponse(TypedDict, total=False):
    version: int
    ...
    config: DeviceGetConfigResponseConfig

class DeviceGetConfigResponse(RequiredDeviceGetConfigResponse, OptionalDeviceGetConfigResponse):
    pass
