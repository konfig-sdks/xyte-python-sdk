...
class RequiredDeviceRegisterChildDevice404Response(TypedDict):
    pass

class OptionalDeviceRegisterChildDevice404Response(TypedDict, total=False):
    error: str

class DeviceRegisterChildDevice404Response(RequiredDeviceRegisterChildDevice404Response, OptionalDeviceRegisterChildDevice404Response):
    pass
