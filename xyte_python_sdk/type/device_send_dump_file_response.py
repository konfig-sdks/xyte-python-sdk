...
class RequiredDeviceSendDumpFileResponse(TypedDict):
    pass

class OptionalDeviceSendDumpFileResponse(TypedDict, total=False):
    id: str

class DeviceSendDumpFileResponse(RequiredDeviceSendDumpFileResponse, OptionalDeviceSendDumpFileResponse):
    pass
