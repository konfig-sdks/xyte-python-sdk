...
class RequiredDeviceListDevicesResponsePageInfo(TypedDict):
    pass

class OptionalDeviceListDevicesResponsePageInfo(TypedDict, total=False):
    has_next: bool

    total_count: int

class DeviceListDevicesResponsePageInfo(RequiredDeviceListDevicesResponsePageInfo, OptionalDeviceListDevicesResponsePageInfo):
    pass
