...
class RequiredDeviceGetCommand401Response(TypedDict):
    pass

class OptionalDeviceGetCommand401Response(TypedDict, total=False):
    error: str

class DeviceGetCommand401Response(RequiredDeviceGetCommand401Response, OptionalDeviceGetCommand401Response):
    pass
