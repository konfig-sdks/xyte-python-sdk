...
class RequiredDeviceUpdateLicense404Response(TypedDict):
    pass

class OptionalDeviceUpdateLicense404Response(TypedDict, total=False):
    error: str

class DeviceUpdateLicense404Response(RequiredDeviceUpdateLicense404Response, OptionalDeviceUpdateLicense404Response):
    pass
