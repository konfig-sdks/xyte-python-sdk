...
from xyte_python_sdk.type.ticket_get_by_id_response_comments import TicketGetByIdResponseComments

class RequiredTicketGetByIdResponse(TypedDict):
    pass

class OptionalTicketGetByIdResponse(TypedDict, total=False):
    title: str
    ...
    comments: TicketGetByIdResponseComments

class TicketGetByIdResponse(RequiredTicketGetByIdResponse, OptionalTicketGetByIdResponse):
    pass
