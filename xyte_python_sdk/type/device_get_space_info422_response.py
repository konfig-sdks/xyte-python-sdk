...
class RequiredDeviceGetSpaceInfo422Response(TypedDict):
    pass

class OptionalDeviceGetSpaceInfo422Response(TypedDict, total=False):
    error: str

class DeviceGetSpaceInfo422Response(RequiredDeviceGetSpaceInfo422Response, OptionalDeviceGetSpaceInfo422Response):
    pass
