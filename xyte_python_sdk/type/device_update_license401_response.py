...
class RequiredDeviceUpdateLicense401Response(TypedDict):
    pass

class OptionalDeviceUpdateLicense401Response(TypedDict, total=False):
    error: str

class DeviceUpdateLicense401Response(RequiredDeviceUpdateLicense401Response, OptionalDeviceUpdateLicense401Response):
    pass
