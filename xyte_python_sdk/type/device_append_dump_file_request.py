...
class RequiredDeviceAppendDumpFileRequest(TypedDict):
    RAW_BODY: str

class OptionalDeviceAppendDumpFileRequest(TypedDict, total=False):
    pass

class DeviceAppendDumpFileRequest(RequiredDeviceAppendDumpFileRequest, OptionalDeviceAppendDumpFileRequest):
    pass
