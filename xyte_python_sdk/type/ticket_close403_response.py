...
class RequiredTicketClose403Response(TypedDict):
    pass

class OptionalTicketClose403Response(TypedDict, total=False):
    error: str

class TicketClose403Response(RequiredTicketClose403Response, OptionalTicketClose403Response):
    pass
