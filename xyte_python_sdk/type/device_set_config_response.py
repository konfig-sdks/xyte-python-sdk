...
class RequiredDeviceSetConfigResponse(TypedDict):
    pass

class OptionalDeviceSetConfigResponse(TypedDict, total=False):
    version: int

    success: bool

class DeviceSetConfigResponse(RequiredDeviceSetConfigResponse, OptionalDeviceSetConfigResponse):
    pass
