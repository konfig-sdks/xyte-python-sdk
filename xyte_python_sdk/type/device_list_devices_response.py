...
from xyte_python_sdk.type.device_list_devices_response_data import DeviceListDevicesResponseData
from xyte_python_sdk.type.device_list_devices_response_page_info import DeviceListDevicesResponsePageInfo

class RequiredDeviceListDevicesResponse(TypedDict):
    pass

class OptionalDeviceListDevicesResponse(TypedDict, total=False):
    data: DeviceListDevicesResponseData

    page_info: DeviceListDevicesResponsePageInfo

class DeviceListDevicesResponse(RequiredDeviceListDevicesResponse, OptionalDeviceListDevicesResponse):
    pass
