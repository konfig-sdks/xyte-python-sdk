...
class RequiredTicketUpdateTicketByIdRequest(TypedDict):
    pass

class OptionalTicketUpdateTicketByIdRequest(TypedDict, total=False):
    # New ticket title
    title: str
...
class TicketUpdateTicketByIdRequest(RequiredTicketUpdateTicketByIdRequest, OptionalTicketUpdateTicketByIdRequest):
    pass
