...
class RequiredDeviceListDevicesResponseDataItemFirmware(TypedDict):
    pass

class OptionalDeviceListDevicesResponseDataItemFirmware(TypedDict, total=False):
    version: str

class DeviceListDevicesResponseDataItemFirmware(RequiredDeviceListDevicesResponseDataItemFirmware, OptionalDeviceListDevicesResponseDataItemFirmware):
    pass
