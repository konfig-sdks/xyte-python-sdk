...
class RequiredTicketGetById401Response(TypedDict):
    pass

class OptionalTicketGetById401Response(TypedDict, total=False):
    error: str

class TicketGetById401Response(RequiredTicketGetById401Response, OptionalTicketGetById401Response):
    pass
