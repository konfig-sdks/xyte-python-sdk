...
class RequiredDeviceSendDumpFileRequest(TypedDict):
    # Raw configuration dump
    RAW_BODY: typing.IO

class OptionalDeviceSendDumpFileRequest(TypedDict, total=False):
    pass

class DeviceSendDumpFileRequest(RequiredDeviceSendDumpFileRequest, OptionalDeviceSendDumpFileRequest):
    pass
