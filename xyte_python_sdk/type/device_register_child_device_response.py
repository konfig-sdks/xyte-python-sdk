...
class RequiredDeviceRegisterChildDeviceResponse(TypedDict):
    pass

class OptionalDeviceRegisterChildDeviceResponse(TypedDict, total=False):
    id: str

    access_key: str

class DeviceRegisterChildDeviceResponse(RequiredDeviceRegisterChildDeviceResponse, OptionalDeviceRegisterChildDeviceResponse):
    pass
