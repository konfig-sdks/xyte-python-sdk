...
RequiredDeviceGetConfigResponseConfigNetwork = TypedDict("RequiredDeviceGetConfigResponseConfigNetwork", {
    })

OptionalDeviceGetConfigResponseConfigNetwork = TypedDict("OptionalDeviceGetConfigResponseConfigNetwork", {
    "ip": str,

    "...": str,
    }, total=False)

class DeviceGetConfigResponseConfigNetwork(RequiredDeviceGetConfigResponseConfigNetwork, OptionalDeviceGetConfigResponseConfigNetwork):
    pass
