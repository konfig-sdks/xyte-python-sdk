...
class RequiredDeviceGetInfo400Response(TypedDict):
    pass

class OptionalDeviceGetInfo400Response(TypedDict, total=False):
    error: str

class DeviceGetInfo400Response(RequiredDeviceGetInfo400Response, OptionalDeviceGetInfo400Response):
    pass
