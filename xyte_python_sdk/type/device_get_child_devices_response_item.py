...
class RequiredDeviceGetChildDevicesResponseItem(TypedDict):
    pass

class OptionalDeviceGetChildDevicesResponseItem(TypedDict, total=False):
    id: str

    sn: str

    mac: typing.Union[bool, date, datetime, dict, float, int, list, str, None]
...
class DeviceGetChildDevicesResponseItem(RequiredDeviceGetChildDevicesResponseItem, OptionalDeviceGetChildDevicesResponseItem):
    pass
