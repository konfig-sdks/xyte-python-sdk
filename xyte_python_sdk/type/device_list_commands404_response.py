...
class RequiredDeviceListCommands404Response(TypedDict):
    pass

class OptionalDeviceListCommands404Response(TypedDict, total=False):
    error: str

class DeviceListCommands404Response(RequiredDeviceListCommands404Response, OptionalDeviceListCommands404Response):
    pass
