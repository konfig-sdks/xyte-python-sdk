...
from xyte_python_sdk.type.device_get_telemetries_response_item_telemetries import DeviceGetTelemetriesResponseItemTelemetries

class RequiredDeviceGetTelemetriesResponseItem(TypedDict):
    pass

class OptionalDeviceGetTelemetriesResponseItem(TypedDict, total=False):
    created_at: str

    device_timestamp: str

    telemetries: DeviceGetTelemetriesResponseItemTelemetries

class DeviceGetTelemetriesResponseItem(RequiredDeviceGetTelemetriesResponseItem, OptionalDeviceGetTelemetriesResponseItem):
    pass
