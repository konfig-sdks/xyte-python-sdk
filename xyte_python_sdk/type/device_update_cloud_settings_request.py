...
RequiredDeviceUpdateCloudSettingsRequest = TypedDict("RequiredDeviceUpdateCloudSettingsRequest", {
    })

OptionalDeviceUpdateCloudSettingsRequest = TypedDict("OptionalDeviceUpdateCloudSettingsRequest", {
...
class DeviceUpdateCloudSettingsRequest(RequiredDeviceUpdateCloudSettingsRequest, OptionalDeviceUpdateCloudSettingsRequest):
    pass
