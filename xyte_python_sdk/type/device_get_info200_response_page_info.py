...
class RequiredDeviceGetInfo200ResponsePageInfo(TypedDict):
    pass

class OptionalDeviceGetInfo200ResponsePageInfo(TypedDict, total=False):
    has_next: bool

    total_count: int

class DeviceGetInfo200ResponsePageInfo(RequiredDeviceGetInfo200ResponsePageInfo, OptionalDeviceGetInfo200ResponsePageInfo):
    pass
