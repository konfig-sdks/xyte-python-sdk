...
class RequiredDeviceSendChildTelemetriesRequest(TypedDict):
...
class OptionalDeviceSendChildTelemetriesRequest(TypedDict, total=False):
    pass

class DeviceSendChildTelemetriesRequest(RequiredDeviceSendChildTelemetriesRequest, OptionalDeviceSendChildTelemetriesRequest):
    pass
