...
class RequiredDeviceAppendDumpFileResponse(TypedDict):
    pass

class OptionalDeviceAppendDumpFileResponse(TypedDict, total=False):
    length: int

class DeviceAppendDumpFileResponse(RequiredDeviceAppendDumpFileResponse, OptionalDeviceAppendDumpFileResponse):
    pass
