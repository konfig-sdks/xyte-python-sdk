...
class RequiredTicketList401Response(TypedDict):
    pass

class OptionalTicketList401Response(TypedDict, total=False):
    error: str

class TicketList401Response(RequiredTicketList401Response, OptionalTicketList401Response):
    pass
