...
from xyte_python_sdk.type.device_get_info_response_config import DeviceGetInfoResponseConfig
from xyte_python_sdk.type.device_get_info_response_custom import DeviceGetInfoResponseCustom
from xyte_python_sdk.type.device_get_info_response_partner import DeviceGetInfoResponsePartner
from xyte_python_sdk.type.device_get_info_response_state import DeviceGetInfoResponseState

class RequiredDeviceGetInfoResponse(TypedDict):
    pass

class OptionalDeviceGetInfoResponse(TypedDict, total=False):
    id: str
...
class DeviceGetInfoResponse(RequiredDeviceGetInfoResponse, OptionalDeviceGetInfoResponse):
    pass
