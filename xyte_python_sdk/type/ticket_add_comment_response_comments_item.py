...
class RequiredTicketAddCommentResponseCommentsItem(TypedDict):
    pass

class OptionalTicketAddCommentResponseCommentsItem(TypedDict, total=False):
    id: int
...
class TicketAddCommentResponseCommentsItem(RequiredTicketAddCommentResponseCommentsItem, OptionalTicketAddCommentResponseCommentsItem):
    pass
