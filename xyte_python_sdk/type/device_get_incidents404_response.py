...
class RequiredDeviceGetIncidents404Response(TypedDict):
    pass

class OptionalDeviceGetIncidents404Response(TypedDict, total=False):
    error: str

class DeviceGetIncidents404Response(RequiredDeviceGetIncidents404Response, OptionalDeviceGetIncidents404Response):
    pass
