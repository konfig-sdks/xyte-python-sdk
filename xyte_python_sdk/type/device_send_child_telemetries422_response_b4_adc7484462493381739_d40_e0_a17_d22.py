...
class RequiredDeviceSendChildTelemetries422ResponseB4Adc7484462493381739D40E0A17D22(TypedDict):
    pass

class OptionalDeviceSendChildTelemetries422ResponseB4Adc7484462493381739D40E0A17D22(TypedDict, total=False):
    config_version: int
    ...
    latest_fw_version: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    latest_fw_file_id: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    space_data_version: int

    success: bool

class DeviceSendChildTelemetries422ResponseB4Adc7484462493381739D40E0A17D22(RequiredDeviceSendChildTelemetries422ResponseB4Adc7484462493381739D40E0A17D22, OptionalDeviceSendChildTelemetries422ResponseB4Adc7484462493381739D40E0A17D22):
    pass
