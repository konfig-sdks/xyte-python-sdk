...
class RequiredDeviceListCommandsResponsePageInfo(TypedDict):
    pass

class OptionalDeviceListCommandsResponsePageInfo(TypedDict, total=False):
    has_next: bool

    total_count: int

class DeviceListCommandsResponsePageInfo(RequiredDeviceListCommandsResponsePageInfo, OptionalDeviceListCommandsResponsePageInfo):
    pass
