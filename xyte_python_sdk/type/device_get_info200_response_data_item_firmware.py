...
class RequiredDeviceGetInfo200ResponseDataItemFirmware(TypedDict):
    pass

class OptionalDeviceGetInfo200ResponseDataItemFirmware(TypedDict, total=False):
    version: str

class DeviceGetInfo200ResponseDataItemFirmware(RequiredDeviceGetInfo200ResponseDataItemFirmware, OptionalDeviceGetInfo200ResponseDataItemFirmware):
    pass
