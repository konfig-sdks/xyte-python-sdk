...
class RequiredDeviceSendCommandRequest(TypedDict):
    status: str

    id: str

class OptionalDeviceSendCommandRequest(TypedDict, total=False):
    message: str

class DeviceSendCommandRequest(RequiredDeviceSendCommandRequest, OptionalDeviceSendCommandRequest):
    pass
