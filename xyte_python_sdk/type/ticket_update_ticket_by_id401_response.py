...
class RequiredTicketUpdateTicketById401Response(TypedDict):
    pass

class OptionalTicketUpdateTicketById401Response(TypedDict, total=False):
    error: str

class TicketUpdateTicketById401Response(RequiredTicketUpdateTicketById401Response, OptionalTicketUpdateTicketById401Response):
    pass
