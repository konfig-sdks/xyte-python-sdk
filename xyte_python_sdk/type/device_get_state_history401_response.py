...
class RequiredDeviceGetStateHistory401Response(TypedDict):
    pass

class OptionalDeviceGetStateHistory401Response(TypedDict, total=False):
    error: str

class DeviceGetStateHistory401Response(RequiredDeviceGetStateHistory401Response, OptionalDeviceGetStateHistory401Response):
    pass
