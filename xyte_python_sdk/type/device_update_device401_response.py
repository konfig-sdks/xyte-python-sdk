...
class RequiredDeviceUpdateDevice401Response(TypedDict):
    pass

class OptionalDeviceUpdateDevice401Response(TypedDict, total=False):
    error: str

class DeviceUpdateDevice401Response(RequiredDeviceUpdateDevice401Response, OptionalDeviceUpdateDevice401Response):
    pass
