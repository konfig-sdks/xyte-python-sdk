...
class RequiredDeviceDeleteDevice401Response(TypedDict):
    pass

class OptionalDeviceDeleteDevice401Response(TypedDict, total=False):
    error: str

class DeviceDeleteDevice401Response(RequiredDeviceDeleteDevice401Response, OptionalDeviceDeleteDevice401Response):
    pass
