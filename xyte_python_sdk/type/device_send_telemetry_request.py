...
class RequiredDeviceSendTelemetryRequest(TypedDict):
    status: str

class OptionalDeviceSendTelemetryRequest(TypedDict, total=False):
    timestamp: date
...
class DeviceSendTelemetryRequest(RequiredDeviceSendTelemetryRequest, OptionalDeviceSendTelemetryRequest):
    pass
