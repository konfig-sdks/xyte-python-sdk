...
class RequiredDeviceGetTelemetries404Response(TypedDict):
    pass

class OptionalDeviceGetTelemetries404Response(TypedDict, total=False):
    error: str

class DeviceGetTelemetries404Response(RequiredDeviceGetTelemetries404Response, OptionalDeviceGetTelemetries404Response):
    pass
