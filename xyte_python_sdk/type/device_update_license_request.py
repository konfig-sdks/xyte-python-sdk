...
class RequiredDeviceUpdateLicenseRequest(TypedDict):
    id: str

    state: str

class OptionalDeviceUpdateLicenseRequest(TypedDict, total=False):
    error: str

class DeviceUpdateLicenseRequest(RequiredDeviceUpdateLicenseRequest, OptionalDeviceUpdateLicenseRequest):
    pass
