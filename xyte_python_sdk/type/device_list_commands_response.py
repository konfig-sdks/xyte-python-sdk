...
from xyte_python_sdk.type.device_list_commands_response_data import DeviceListCommandsResponseData
from xyte_python_sdk.type.device_list_commands_response_page_info import DeviceListCommandsResponsePageInfo

class RequiredDeviceListCommandsResponse(TypedDict):
    pass

class OptionalDeviceListCommandsResponse(TypedDict, total=False):
    data: DeviceListCommandsResponseData

    page_info: DeviceListCommandsResponsePageInfo

class DeviceListCommandsResponse(RequiredDeviceListCommandsResponse, OptionalDeviceListCommandsResponse):
    pass
