...
class RequiredDeviceGetIncidentsResponse(TypedDict):
    pass

class OptionalDeviceGetIncidentsResponse(TypedDict, total=False):
    success: bool

class DeviceGetIncidentsResponse(RequiredDeviceGetIncidentsResponse, OptionalDeviceGetIncidentsResponse):
    pass
