...
class RequiredDeviceListDevicesResponseDataItemModel(TypedDict):
    pass

class OptionalDeviceListDevicesResponseDataItemModel(TypedDict, total=False):
    id: str
...
class DeviceListDevicesResponseDataItemModel(RequiredDeviceListDevicesResponseDataItemModel, OptionalDeviceListDevicesResponseDataItemModel):
    pass
