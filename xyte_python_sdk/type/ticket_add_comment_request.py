...
class RequiredTicketAddCommentRequest(TypedDict):
    pass

class OptionalTicketAddCommentRequest(TypedDict, total=False):
    # Message to post
    message: str

class TicketAddCommentRequest(RequiredTicketAddCommentRequest, OptionalTicketAddCommentRequest):
    pass
