...
class RequiredDeviceUpdateCloudSettings401Response(TypedDict):
    pass

class OptionalDeviceUpdateCloudSettings401Response(TypedDict, total=False):
    error: str

class DeviceUpdateCloudSettings401Response(RequiredDeviceUpdateCloudSettings401Response, OptionalDeviceUpdateCloudSettings401Response):
    pass
