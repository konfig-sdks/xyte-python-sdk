...
from xyte_python_sdk.type.device_get_space_info_response_location import DeviceGetSpaceInfoResponseLocation

class RequiredDeviceGetSpaceInfoResponse(TypedDict):
    pass

class OptionalDeviceGetSpaceInfoResponse(TypedDict, total=False):
...
class DeviceGetSpaceInfoResponse(RequiredDeviceGetSpaceInfoResponse, OptionalDeviceGetSpaceInfoResponse):
    pass
