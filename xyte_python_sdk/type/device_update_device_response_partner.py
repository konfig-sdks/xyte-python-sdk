...
class RequiredDeviceUpdateDeviceResponsePartner(TypedDict):
    pass

class OptionalDeviceUpdateDeviceResponsePartner(TypedDict, total=False):
    sn: str
...
class DeviceUpdateDeviceResponsePartner(RequiredDeviceUpdateDeviceResponsePartner, OptionalDeviceUpdateDeviceResponsePartner):
    pass
