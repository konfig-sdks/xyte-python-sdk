...
class RequiredDeviceGetInfo401Response(TypedDict):
    pass

class OptionalDeviceGetInfo401Response(TypedDict, total=False):
    error: str

class DeviceGetInfo401Response(RequiredDeviceGetInfo401Response, OptionalDeviceGetInfo401Response):
    pass
