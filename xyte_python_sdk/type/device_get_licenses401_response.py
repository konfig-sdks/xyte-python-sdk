...
class RequiredDeviceGetLicenses401Response(TypedDict):
    pass

class OptionalDeviceGetLicenses401Response(TypedDict, total=False):
    error: str

class DeviceGetLicenses401Response(RequiredDeviceGetLicenses401Response, OptionalDeviceGetLicenses401Response):
    pass
