...
class RequiredDeviceSendCommandResponse(TypedDict):
    pass

class OptionalDeviceSendCommandResponse(TypedDict, total=False):
    success: bool

class DeviceSendCommandResponse(RequiredDeviceSendCommandResponse, OptionalDeviceSendCommandResponse):
    pass
