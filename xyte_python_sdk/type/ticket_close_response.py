...
from xyte_python_sdk.type.ticket_close_response_comments import TicketCloseResponseComments

class RequiredTicketCloseResponse(TypedDict):
    pass

class OptionalTicketCloseResponse(TypedDict, total=False):
    title: str
    ...
    comments: TicketCloseResponseComments

class TicketCloseResponse(RequiredTicketCloseResponse, OptionalTicketCloseResponse):
    pass
