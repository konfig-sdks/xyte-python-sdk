...
class RequiredDeviceGetConfig401Response(TypedDict):
    pass

class OptionalDeviceGetConfig401Response(TypedDict, total=False):
    error: str

class DeviceGetConfig401Response(RequiredDeviceGetConfig401Response, OptionalDeviceGetConfig401Response):
    pass
