...
class RequiredDeviceSendChildTelemetries401Response(TypedDict):
    pass

class OptionalDeviceSendChildTelemetries401Response(TypedDict, total=False):
    error: str

class DeviceSendChildTelemetries401Response(RequiredDeviceSendChildTelemetries401Response, OptionalDeviceSendChildTelemetries401Response):
    pass
