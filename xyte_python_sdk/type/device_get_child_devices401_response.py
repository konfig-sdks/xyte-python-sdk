...
class RequiredDeviceGetChildDevices401Response(TypedDict):
    pass

class OptionalDeviceGetChildDevices401Response(TypedDict, total=False):
    error: str

class DeviceGetChildDevices401Response(RequiredDeviceGetChildDevices401Response, OptionalDeviceGetChildDevices401Response):
    pass
