...
class RequiredDeviceOpenIncidentRequest(TypedDict):
    # Short title
    title: str

class OptionalDeviceOpenIncidentRequest(TypedDict, total=False):
    description: str
...
class DeviceOpenIncidentRequest(RequiredDeviceOpenIncidentRequest, OptionalDeviceOpenIncidentRequest):
    pass
