...
class RequiredDeviceSendDumpFile401Response(TypedDict):
    pass

class OptionalDeviceSendDumpFile401Response(TypedDict, total=False):
    error: str

class DeviceSendDumpFile401Response(RequiredDeviceSendDumpFile401Response, OptionalDeviceSendDumpFile401Response):
    pass
