...
class RequiredDeviceSendCommand401Response(TypedDict):
    pass

class OptionalDeviceSendCommand401Response(TypedDict, total=False):
    error: str

class DeviceSendCommand401Response(RequiredDeviceSendCommand401Response, OptionalDeviceSendCommand401Response):
    pass
