...
from xyte_python_sdk.type.device_get_space_info_response_location_coordinates import DeviceGetSpaceInfoResponseLocationCoordinates

class RequiredDeviceGetSpaceInfoResponseLocation(TypedDict):
    pass

class OptionalDeviceGetSpaceInfoResponseLocation(TypedDict, total=False):
...
class DeviceGetSpaceInfoResponseLocation(RequiredDeviceGetSpaceInfoResponseLocation, OptionalDeviceGetSpaceInfoResponseLocation):
    pass
