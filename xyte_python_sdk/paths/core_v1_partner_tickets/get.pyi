...
from xyte_python_sdk.model.ticket_list401_response import TicketList401Response as TicketList401ResponseSchema
from xyte_python_sdk.model.ticket_list_response import TicketListResponse as TicketListResponseSchema

from xyte_python_sdk.type.ticket_list_response import TicketListResponse
from xyte_python_sdk.type.ticket_list401_response import TicketList401Response

from ...api_client import Dictionary
from xyte_python_sdk.pydantic.ticket_list401_response import TicketList401Response as TicketList401ResponsePydantic
from xyte_python_sdk.pydantic.ticket_list_response import TicketListResponse as TicketListResponsePydantic

SchemaFor200ResponseBodyApplicationJson = TicketListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TicketListResponse
...
SchemaFor401ResponseBodyApplicationJson = TicketList401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: TicketList401Response
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/core/v1/partner/tickets',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TicketListResponsePydantic:
        raw_response = await self.raw.alist(
            **kwargs,
        )
        if validate:
            return RootModel[TicketListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(TicketListResponsePydantic, raw_response.body)
