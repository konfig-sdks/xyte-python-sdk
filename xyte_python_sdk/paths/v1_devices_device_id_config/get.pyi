...
from xyte_python_sdk.model.device_get_config_response import DeviceGetConfigResponse as DeviceGetConfigResponseSchema

from xyte_python_sdk.type.device_get_config_response import DeviceGetConfigResponse
...
from xyte_python_sdk.pydantic.device_get_config_response import DeviceGetConfigResponse as DeviceGetConfigResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DeviceGetConfigResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DeviceGetConfigResponse
...
class GetConfig(BaseApi):
    ...
    async def aget_config(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeviceGetConfigResponsePydantic:
        raw_response = await self.raw.aget_config(
            device_id=device_id,
            **kwargs,
        )
        if validate:
            return DeviceGetConfigResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DeviceGetConfigResponsePydantic, raw_response.body)
