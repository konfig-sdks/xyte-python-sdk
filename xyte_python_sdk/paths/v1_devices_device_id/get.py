...
from xyte_python_sdk.model.device_get_info_response import DeviceGetInfoResponse as DeviceGetInfoResponseSchema
from xyte_python_sdk.model.device_get_info400_response import DeviceGetInfo400Response as DeviceGetInfo400ResponseSchema

from xyte_python_sdk.type.device_get_info_response import DeviceGetInfoResponse
from xyte_python_sdk.type.device_get_info400_response import DeviceGetInfo400Response

from ...api_client import Dictionary
from xyte_python_sdk.pydantic.device_get_info_response import DeviceGetInfoResponse as DeviceGetInfoResponsePydantic
from xyte_python_sdk.pydantic.device_get_info400_response import DeviceGetInfo400Response as DeviceGetInfo400ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DeviceGetInfoResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DeviceGetInfoResponse
...
SchemaFor400ResponseBodyApplicationJson = DeviceGetInfo400ResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: DeviceGetInfo400Response
...
class GetInfo(BaseApi):
    ...
    async def aget_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeviceGetInfoResponsePydantic:
        raw_response = await self.raw.aget_info(
            device_id=device_id,
            **kwargs,
        )
        if validate:
            return DeviceGetInfoResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DeviceGetInfoResponsePydantic, raw_response.body)
