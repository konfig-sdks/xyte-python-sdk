...
from xyte_python_sdk.model.device_get_command401_response import DeviceGetCommand401Response as DeviceGetCommand401ResponseSchema

from xyte_python_sdk.type.device_get_command401_response import DeviceGetCommand401Response

from ...api_client import Dictionary
from xyte_python_sdk.pydantic.device_get_command401_response import DeviceGetCommand401Response as DeviceGetCommand401ResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = DeviceGetCommand401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: DeviceGetCommand401Response
...
class GetCommandRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_command(
        self,
        device_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_command_mapped_args(
            device_id=device_id,
        )
        return await self._aget_command_oapg(
    ...
    def get_command(
        ...
        return self._get_command_oapg(
            path_params=args.path,
        )

class GetCommand(BaseApi):
    ...
    async def aget_command(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_command(
            device_id=device_id,
            **kwargs,
        )
        if validate:
    ...
    def get_command(
        ...
        raw_response = self.raw.get_command(
            device_id=device_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
