...
class TicketAddCommentResponseComments(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TicketAddCommentResponseCommentsItem']:
            return TicketAddCommentResponseCommentsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TicketAddCommentResponseCommentsItem'], typing.List['TicketAddCommentResponseCommentsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'TicketAddCommentResponseComments':
    ...
    def __getitem__(self, i: int) -> 'TicketAddCommentResponseCommentsItem':
