...
class TicketListResponse(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TicketListResponseItem']:
            return TicketListResponseItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TicketListResponseItem'], typing.List['TicketListResponseItem']],
    ...
    def __getitem__(self, i: int) -> 'TicketListResponseItem':
