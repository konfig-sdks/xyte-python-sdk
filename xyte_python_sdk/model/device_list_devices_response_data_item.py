...
class DeviceListDevicesResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def model() -> typing.Type['DeviceListDevicesResponseDataItemModel']:
                return DeviceListDevicesResponseDataItemModel
        
            @staticmethod
            def firmware() -> typing.Type['DeviceListDevicesResponseDataItemFirmware']:
                return DeviceListDevicesResponseDataItemFirmware
            __annotations__ = {
                "id": id,
                "sn": sn,
                "mac": mac,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["model"]) -> 'DeviceListDevicesResponseDataItemModel': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["firmware"]) -> 'DeviceListDevicesResponseDataItemFirmware': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["model"]) -> typing.Union['DeviceListDevicesResponseDataItemModel', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["firmware"]) -> typing.Union['DeviceListDevicesResponseDataItemFirmware', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        model: typing.Union['DeviceListDevicesResponseDataItemModel', schemas.Unset] = schemas.unset,
        firmware: typing.Union['DeviceListDevicesResponseDataItemFirmware', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'DeviceListDevicesResponseDataItem':
