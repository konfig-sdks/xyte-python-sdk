...
class DeviceGetChildDevicesResponse(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DeviceGetChildDevicesResponseItem']:
            return DeviceGetChildDevicesResponseItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['DeviceGetChildDevicesResponseItem'], typing.List['DeviceGetChildDevicesResponseItem']],
    ...
    def __getitem__(self, i: int) -> 'DeviceGetChildDevicesResponseItem':
