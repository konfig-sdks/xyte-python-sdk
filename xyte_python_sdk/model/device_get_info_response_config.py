...
class DeviceGetInfoResponseConfig(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "vol", "last_updated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "vol", "last_updated", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        vol: typing.Union[MetaOapg.properties.vol, decimal.Decimal, int, schemas.Unset] = schemas.unset,
