...
class DeviceOpenIncidentResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            incident_id = schemas.StrSchema
            __annotations__ = {
                "incident_id": incident_id,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["incident_id"]) -> MetaOapg.properties.incident_id: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["incident_id", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["incident_id"]) -> typing.Union[MetaOapg.properties.incident_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["incident_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        incident_id: typing.Union[MetaOapg.properties.incident_id, str, schemas.Unset] = schemas.unset,
