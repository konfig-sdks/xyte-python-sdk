...
class DeviceGetTelemetriesResponse(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DeviceGetTelemetriesResponseItem']:
            return DeviceGetTelemetriesResponseItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['DeviceGetTelemetriesResponseItem'], typing.List['DeviceGetTelemetriesResponseItem']],
    ...
    def __getitem__(self, i: int) -> 'DeviceGetTelemetriesResponseItem':
