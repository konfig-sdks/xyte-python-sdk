...
class DeviceListCommandsResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["parameters", "id", "status", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["parameters", "id", "status", "name", ], str]):
    ...
    ) -> 'DeviceListCommandsResponseDataItem':
