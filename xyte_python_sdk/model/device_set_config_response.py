...
class DeviceSetConfigResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "success", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "success", ], str]):
