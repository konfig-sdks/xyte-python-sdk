...
class TicketUpdateTicketByIdResponseComments(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TicketUpdateTicketByIdResponseCommentsItem']:
            return TicketUpdateTicketByIdResponseCommentsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TicketUpdateTicketByIdResponseCommentsItem'], typing.List['TicketUpdateTicketByIdResponseCommentsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'TicketUpdateTicketByIdResponseComments':
    ...
    def __getitem__(self, i: int) -> 'TicketUpdateTicketByIdResponseCommentsItem':
