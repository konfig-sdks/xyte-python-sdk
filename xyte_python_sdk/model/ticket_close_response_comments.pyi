...
class TicketCloseResponseComments(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TicketCloseResponseCommentsItem']:
            return TicketCloseResponseCommentsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TicketCloseResponseCommentsItem'], typing.List['TicketCloseResponseCommentsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'TicketCloseResponseComments':
    ...
    def __getitem__(self, i: int) -> 'TicketCloseResponseCommentsItem':
