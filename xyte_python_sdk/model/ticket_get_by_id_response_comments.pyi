...
class TicketGetByIdResponseComments(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TicketGetByIdResponseCommentsItem']:
            return TicketGetByIdResponseCommentsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TicketGetByIdResponseCommentsItem'], typing.List['TicketGetByIdResponseCommentsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'TicketGetByIdResponseComments':
    ...
    def __getitem__(self, i: int) -> 'TicketGetByIdResponseCommentsItem':
