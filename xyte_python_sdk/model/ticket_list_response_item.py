...
class TicketListResponseItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "description", "id", "status", "created_at", "device_id", "user_name", "user_email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "description", "id", "status", "created_at", "device_id", "user_name", "user_email", ], str]):
