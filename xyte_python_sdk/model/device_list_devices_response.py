...
class DeviceListDevicesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['DeviceListDevicesResponseData']:
                return DeviceListDevicesResponseData
        
            @staticmethod
            def page_info() -> typing.Type['DeviceListDevicesResponsePageInfo']:
                return DeviceListDevicesResponsePageInfo
            __annotations__ = {
                "data": data,
                "page_info": page_info,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'DeviceListDevicesResponseData': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["page_info"]) -> 'DeviceListDevicesResponsePageInfo': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['DeviceListDevicesResponseData', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["page_info"]) -> typing.Union['DeviceListDevicesResponsePageInfo', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        data: typing.Union['DeviceListDevicesResponseData', schemas.Unset] = schemas.unset,
        page_info: typing.Union['DeviceListDevicesResponsePageInfo', schemas.Unset] = schemas.unset,
