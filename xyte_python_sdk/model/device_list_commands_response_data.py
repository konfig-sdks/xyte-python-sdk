...
class DeviceListCommandsResponseData(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DeviceListCommandsResponseDataItem']:
            return DeviceListCommandsResponseDataItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['DeviceListCommandsResponseDataItem'], typing.List['DeviceListCommandsResponseDataItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'DeviceListCommandsResponseData':
    ...
    def __getitem__(self, i: int) -> 'DeviceListCommandsResponseDataItem':
