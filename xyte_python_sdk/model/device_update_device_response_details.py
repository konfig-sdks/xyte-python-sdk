...
class DeviceUpdateDeviceResponseDetails(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            checking = schemas.StrSchema
            __annotations__ = {
                "checking": checking,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["checking"]) -> MetaOapg.properties.checking: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["checking", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["checking"]) -> typing.Union[MetaOapg.properties.checking, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["checking", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        checking: typing.Union[MetaOapg.properties.checking, str, schemas.Unset] = schemas.unset,
