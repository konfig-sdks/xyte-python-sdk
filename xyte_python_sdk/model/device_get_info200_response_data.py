...
class DeviceGetInfo200ResponseData(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DeviceGetInfo200ResponseDataItem']:
            return DeviceGetInfo200ResponseDataItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['DeviceGetInfo200ResponseDataItem'], typing.List['DeviceGetInfo200ResponseDataItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'DeviceGetInfo200ResponseData':
    ...
    def __getitem__(self, i: int) -> 'DeviceGetInfo200ResponseDataItem':
